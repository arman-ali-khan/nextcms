               ...
               {/* Login Btn */}
               {
                !siteUser?.email ? 
                 <div className="text-xs flex items-center gap-2">
                    <Link className=" inline-block border border-[#ddd] p-[5px] hover:bg-base-300" href={`/${siteId?.siteurl}/auth/login`}>Login</Link>
                    <Link className=" inline-block border border-[#ddd] p-[5px] hover:bg-base-300" href={`/${siteId?.siteurl}/auth/register`}>Signup</Link>
                </div>
                :
        ...
        <div className="bg-accent text-base-100 border-b-2 border-error">
            <div className="flex justify-between items-center">
                <ul className="flex items-center">
                    <li><Link className="hover:bg-error pb-0.5 px-2 duration-200 border-r border-[#222]" href={`/${siteId?.siteurl}`}>Home</Link></li>
                    {
                    ...
                    {/* admin route */}
                    {
                        siteUser.type==='admin' && <li><Link className="hover:bg-error pb-0.5 px-2 duration-200 border-r border-[#222]"href={`/${siteId.siteurl}/admin`}>Admin</Link></li>
                    }
